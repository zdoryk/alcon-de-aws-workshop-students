...
def main(handler=None, context=None):
    ...
    df = wr.s3.read_csv(path='s3://alcon-workshop-data-099605873748/raw/17-11-2023_11.csv', sep=',', header=0)

    # Task #1
    df['IS_DEAD'] = df['DATE_DIED'].apply(lambda x: True if x == '9999-99-99' else False)
